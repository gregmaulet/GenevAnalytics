...
#4.6) Pas besoin pour medecin parce que j'ai pas les dates d'entree en service des medecins, du coup un plot serait questionnable pour voir l'evolution

#4.7) Pas besoin pour les parcs, comme pour ecole

#4.8) Pas besoin pour les supermarches comme pour ecole
...
fplotinfraction("Geneve")

fplotprixappart("Geneve")

fplotprixvilla("Geneve")

fplotdensitepopulation("Geneve")



freturnDI("Geneve","2010")

freturnloyer("Geneve","2010")

freturnecole("Geneve")

freturnpopulation("Geneve","2010")

freturninfraction("Geneve","2010")

freturnmedecin("Geneve")

freturnparc("Geneve")

freturnsupermarche("Geneve")

freturnprixappart("Geneve","2010")

freturnprixvilla("Geneve","2010")
