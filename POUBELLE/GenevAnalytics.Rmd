...
#CITIES COORDINATES
cities_coordinates <- matrix(NA, 45, 3)
cities_coordinates[,1] <- Commune[2:46,1]
colnames(cities_coordinates) = c("city", "lat", "lng")
cities_coordinates[1,2:3] <- c(46.17, 6.0067)
cities_coordinates[2,2:3] <- c(46.2833, 6.2167)
cities_coordinates[3,2:3] <- c(46.1833, 6.0611)
cities_coordinates[4,2:3] <- c(46.17, 6.0067)
cities_coordinates[5,2:3] <- c(46.149, 6.118)
cities_coordinates[6,2:3] <- c(46.2667, 6.15)
cities_coordinates[7,2:3] <- c(46.1833, 6.0833)
cities_coordinates[8,2:3] <- c(46.1833, 6.125)
cities_coordinates[9,2:3] <- c(46.1833, 6.0167)
cities_coordinates[10,2:3] <- c(46.35, 6.2)
cities_coordinates[11,2:3] <- c(46.15, 5.9667)
cities_coordinates[12,2:3] <- c(46.2, 6.1667)
cities_coordinates[13,2:3] <- c(46.2, 6.2)
cities_coordinates[14,2:3] <- c(46.2467, 6.1933)
cities_coordinates[15,2:3] <- c(46.2797, 6.122)
cities_coordinates[16,2:3] <- c(46.2467, 6.1933)
cities_coordinates[17,2:3] <- c(46.1929, 6.1571)
cities_coordinates[18,2:3] <- c(46.1833, 6.0833)
cities_coordinates[19,2:3] <- c(46.2467, 6.1933)
cities_coordinates[20,2:3] <- c(46.2, 6)
cities_coordinates[21,2:3] <- c(46.2, 6.1667)
cities_coordinates[22,2:3] <- c(46.3971, 6.269)
cities_coordinates[23,2:3] <- c(46.2333, 6.1333)
cities_coordinates[24,2:3] <- c(46.252, 6.257)
cities_coordinates[25,2:3] <- c(46.3, 6.2333)
cities_coordinates[26,2:3] <- c(46.25, 6.2833)
cities_coordinates[27,2:3] <- c(46.17, 6.0067)
cities_coordinates[28,2:3] <- c(46.2111, 6.1028)
cities_coordinates[29,2:3] <- c(46.2333, 6.2333)
cities_coordinates[30,2:3] <- c(46.2167, 6.0667)
cities_coordinates[31,2:3] <- c(46.1833, 6.1)
cities_coordinates[32,2:3] <- c(46.1581, 6.0876)
cities_coordinates[33,2:3] <- c(46.1667, 6.1167)
cities_coordinates[34,2:3] <- c(46.25, 6.1333)
cities_coordinates[35,2:3] <- c(46.2333, 6.25)
cities_coordinates[36,2:3] <- c(46.2, 6.2333)
cities_coordinates[37,2:3] <- c(46.1833, 6.0167)
cities_coordinates[38,2:3] <- c(46.2167, 6.0333)
cities_coordinates[39,2:3] <- c(46.1333, 6.05)
cities_coordinates[40,2:3] <- c(46.1833, 6.1667)
cities_coordinates[41,2:3] <- c(46.2208, 6.2292)
cities_coordinates[42,2:3] <- c(46.2167, 6.2)
cities_coordinates[43,2:3] <- c(46.2167, 6.0833)
cities_coordinates[44,2:3] <- c(46.2833, 6.1667)
cities_coordinates[45,2:3] <- c(46.1833, 6.2)
...
```{r} 
#Leaflet example for Matthias : r?gler manuellement les valeurs et donc laborieux
library(leaflet)
library(htmltools)
...
lat = c(46.1833)
lon = c(6.1)
HW2table = data.frame(cbind(lat, lon))

table2 <- c("Onex")

m <- leaflet() %>%
  addTiles() %>%  
  addPopups(lng = HW2table$lon, lat = HW2table$lat, table2 , options = popupOptions(closeButton=FALSE)) %>%
  addCircleMarkers(lng=HW2table$lon, lat=HW2table$lat,radius = HW2table$Champions)

m
```

##Latitude longitude dataframe for Matthias 
latlon0  <- as.data.frame(cities_coordinates)
latlon <- latlon0[,-1]
rownames(latlon) <- latlon0[,1]

freturnlatlon <- function(a){x <- latlon[c(a),]
return(x)
}
#Example
freturnlatlon("Geneve")

##Fonction pour automatiser leaflet. Besoin de chunk sinon ?a fait rien et le processeur de l'ordi fait n'imp. MAJ : ne marche plus  !!
```{r}
library(leaflet)
library(htmltools)

experiment <- function(a){city <- c(a)
