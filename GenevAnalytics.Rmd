...
```{r} 
#Leaflet example for Matthias : régler manuellement les valeurs et donc laborieux
library(leaflet)
library(htmltools)
...
latlon <- Latitude_Longitude[,-1]
rownames(latlon) <- Latitude_Longitude[,1]
...
##Fonction pour automatiser leaflet. Besoin de chunk sinon ça fait rien et le processeur de l'ordi fait n'imp
```{r}
library(leaflet)
library(htmltools)
